        ...
        <Center flex={1} h="20%" m={1}>
          <VStack paddingLeft={4} paddingRight={4} space={4} flex={2} w="100%">
            ...
            <Button
              ...
              onPress={login}
              textoBase="Ingresar"
              textoEvento="Ingresando"
              estado={estado}>
              <Text color="#ffffff" bold fontSize={'xl'}>
                Ingresar
              </Text>
            </Button>
            ...
            <Box alignItems="center" pt={0} pb={1}>
              <Text mt={340} bold color="#BDBFC1" fontSize={15} italic>
                Customer Service - Bernardo Lew 2023
              </Text>
              <Text mt={1} bold color="#BDBFC1" fontSize={15} italic>
                v7.5
              </Text>
            </Box>
          </VStack>
